...
const handleUploadImage = async (e) => {
  ...
  setMessage(prev => {
    return {...prev, imageUrl: uploadedPhoto }
  })
}
      ...
      <header className='sticky top-0 h-16 bg-white flex justify-between items-center px-4'>
          ...
          <section className='h-16 bg-white flex items-center px-4'>
              <div className='relative '>
                  <button onClick={handleUploadImageVideoOpen} className='flex justify-center items-center w-11 h-11 rounded-full hover:bg-blue-400 hover:text-white'>
                    <FaPlus size={20}/>
                  </button>
